...
<td><a href="<?php echo base_url();?>index.php/Officer_Controller/d_edit/<?php echo $key->dentistID;?>"/><?php echo $key->dentistID;?></a></td>  
<td><?php echo $key->f_name?></td>
<td><?php echo $key->l_name?></td>
<td><?php echo $key->address?></td>
<td><?php echo $key->tel?></td>
<td><?php echo $key->email?></td>
<td><a href="<?php echo base_url();?>index.php/Officer_Controller/d_delete/<?php echo $key->dentistID;?>"/>Delete</a></td>
<td><a href="<?php echo base_url();?>index.php/Officer_Controller/d_edit/<?php echo $key->dentistID;?>"/>Edit</a></td> 
</tr>
<?php endforeach; ?>
<?php else: ?>
No data
