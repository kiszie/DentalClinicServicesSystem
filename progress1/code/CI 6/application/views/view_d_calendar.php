...
<?php /*?>    <?php 
   	...
   	if(!empty($ID)){
    	echo "<h1><a href='#'>$ID</a>  :   <a href='logout/'>LOGOUT</a></h1>";
    }
    else{
...
<td><a href="<?php echo base_url();?>index.php/Officer_Controller/dentistCalendar/<?php echo $key->dentistID;?>"/><?php echo $key->dentistID;?></a></td>  
