	...
	<div class="wrapper">
        ...
        <nav>
            <ul>
                ...
                <li><a href="Officer_Controller/make_appointment">Make Appointment</a>
                </li>
                <li>
                	<a href="Officer_Controller/callCalendar">Schedule</a>
                    <ul class="sub-menu">
                    	<li><a href="Officer_controller/view_appointment">Appointment</a></li>
                        <li><a href="Officer_controller/view_p_calendar">Patient</a></li>
                        <li><a href="Officer_Controller/view_d_calendar">Dentist</a></li>
                        
                    </ul>
                </li>
                <li><a href="Officer_Controller/get_p_db">Account</a> 
                	<ul class="sub-menu">
                        <li><a href="Officer_Controller/p_register">New Patient</a></li>
                        <li><a href="Officer_Controller/d_register">New Dentist</a></li>
                        <li><a href="Officer_Controller/get_db">Dentists' Account</a></li>
                        <li><a href="Officer_Controller/get_p_db">Patients' Account</a></li>
                    </ul></li>
