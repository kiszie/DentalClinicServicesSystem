...
<form id="form1" name="form1" method="post" action="<?php echo base_url();?>index.php/Officer_Controller/edit_data/">
        ...
        <p>
          ...
          <input id="f_name" name="f_name" type="text"  value="<?php echo $user['f_name'];?>" required><span class="alert"><span class="alert">*</span>
        </p>
        <p>
            <label for="l_name">Last name:</label>
          <input id="l_name" name="l_name" type="text"  value="<?php echo $user['l_name'];?>" required><span class="alert">*</span>
        </p>
        <p>
         <label for="age">Age:</label>
          <input id="age"  name="age" type="text"  value="<?php echo $user['age'];?>"required><span class="alert">*</span>
        </p>
        <p>
            <label for="gender">Gender:</label>
          <input id="gender" name="gender" type="text"  value="<?php echo $user['gender'];?>"required><span class="alert">*</span>
        </p>
        <p>
            <label for="address">Address:</label>
          <input id="address" name="address" type="text"  value="<?php echo $user['address'];?>"required><span class="alert">*</span>
        </p>
        ...
        <input id="phone" name="tel" type="tel" value="<?php echo $user['tel'];?>" required><span class="alert">*</span>
   	  ...
   	  <input type="submit" name="submit" class="continue" value ="Edit"></input>
      </form>
