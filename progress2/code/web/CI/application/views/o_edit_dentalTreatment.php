...
<article id="p_register">
	<form id="form1" name="form1" method="post" action="<?php echo base_url();?>index.php/Officer_Controller/edit_dental_treatment_data">
    	<h1>Add Dental Treatment</h1>
        
      	<p>
            <label for="tid">Treatment ID:</label>
          <input id="tid" name="tid" type="text" value="<?php echo $treatment['tid'];?>" required><span class="alert">*</span>
        </p>
        <p>
            <label for="tName">Treatment:</label>
          <input id="tName" name="tName" type="text" value="<?php echo $treatment['tName'];?>" required><span class="alert">*</span>
        </p>
       	<p>
            <label for="cost">Cost:</label>
          <input id="cost" name="cost" type="text" value="<?php echo $treatment['cost'];?>" required><span class="alert">*</span>
        </p>
