...
<article id="p_register">
	<form id="form1" name="form1" method="post" action="<?php echo base_url();?>index.php/Officer_Controller/add_info_data">
        ...
        <p>
          ...
          <input id="title" name="title" type="text" required><span class="alert">*</span>
        </p>
       	<p>
          <label for="details">Details:</label>
          <input id="details" name="details" type="text" required><span class="alert">*</span>
        </p>
        <p>
          <label for="officerID">OfficerID:</label>
          <input id="officerID" name="officerID" type="text" required><span class="alert">*</span>
        </p>
