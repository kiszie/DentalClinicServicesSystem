	...
	<div class="wrapper">
       ...
       <nav>
             ...
             echo "<li><a href='#'>Login</a>
             	<ul class='sub-menu'>
                        <li><a href='<?php echo base_url();?>index.php/Patient_Controller/login'>Patient Login</a></li>
                        <li><a href='<?php echo base_url();?>index.php/Dentist_Controller/login'>Dentist Login</a></li>
                        <li><a href='<?php echo base_url();?>index.php/Officer_Controller/login'>Officer Login</a></li>
                    </ul>
             </li>";
             }
             ?>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?php echo base_url();?>index.php/Dentist_Controller/dentistCalendar/<?php echo $ID;?>">Your Schedule</a></li>
