	...
	<div class="wrapper">
       ...
       <nav>
            <ul>
                ...
                <li>
                	<a href="<?php echo base_url();?>index.php/Patient_Controller/callCalendar">Schedule</a>
                    <ul class="sub-menu">
                       <li><a href="<?php echo base_url();?>index.php/Patient_Controller/patientCalendar/<?php echo isset($PID);?>">Your Schedule</a></li>
                    </ul>
                </li>
